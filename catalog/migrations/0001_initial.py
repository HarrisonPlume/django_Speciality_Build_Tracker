# Generated by Django 3.2.5 on 2021-07-05 22:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Enter a breif                               description of the book in question.', max_length=1000)),
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, help_text='Unique Book Id for each instance', primary_key=True, serialize=False)),
