...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalog', '0055_auto_20210720_0826'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='status',
            field=models.CharField(choices=[('a', 'Not Started'), ('h', 'On Hold'), ('z', 'Complete'), ('b', 'In Progress')], default='a', help_text='Set                                   task completion status', max_length=1),
        ),
        migrations.AlterField(
